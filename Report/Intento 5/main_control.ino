// =====================================================================
// PROYECTO   : Desarrollo de Asistente Individual de Ingeniería Rex
...
void setup() {
  ...
  registrarEvento("INFO", "Sistema iniciado — Desarrollo de Asistente Individual de Ingeniería Rex");
