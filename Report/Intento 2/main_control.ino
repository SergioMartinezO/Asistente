// =====================================================================
// PROYECTO   : Sistema de Encendido de Bombillo por Comandos de Voz
...
void setup() {
  ...
  registrarEvento("INFO", "Sistema iniciado — Sistema de Encendido de Bombillo por Comandos de Voz");
