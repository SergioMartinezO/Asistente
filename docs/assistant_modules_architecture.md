...
## Recursos recomendados para diseño electrónico

Si necesitas solicitar diseños de producto electrónico con cronograma por fases, entregables, costos/riesgos o formato de propuesta comercial, consulta:

- `docs/plantillas_indice.md`

Este índice te orienta sobre qué plantilla usar según el objetivo (diseño técnico, evaluación económica o propuesta comercial).
