...
class MainWindow(QMainWindow):
    ...
    def __init__(self, face_path: str):
        ...
        # Callback inyectado por el controlador para cierre limpio
        self.on_close_callback = None

    def closeEvent(self, event):
        """Intercepta el cierre de ventana para hacer un shutdown ordenado.

        Si el controlador registró un callback de cierre, se llama primero
        para guardar sesión y liberar recursos (evita bloqueo del SO).
        El evento se acepta siempre para que la ventana cierre sin importar
...
class RexUI:
    def __init__(self, face_path: str, size=None):
        # Desactivar el escalado automático ANTES de crear QApplication para
        # evitar que Qt6 intente llamar SetProcessDpiAwarenessContext() cuando
        # el runtime de Python ya estableció el contexto DPI (Access Denied).
