...
ERROR_ANALYST_PROMPT = """You are the error recovery module of Asistente AI assistant.
...
def analyze_error(
    ...
    if attempt >= max_attempts:
        ...
        return {
            ...
            "max_retries":   0,
            "user_message":  "Intentando un enfoque diferente."
        }
...
Attempt number: {attempt}"""
    ...
    try:
        ...
        if step.get("critical") and result["decision"] == ErrorDecision.SKIP:
            ...
            result["user_message"] = "Este paso es crítico; buscando alternativa."
        ...
        return {
            ...
            "max_retries":    1,
            "user_message":   "Se detectó un problema; ajustando enfoque."
        }
